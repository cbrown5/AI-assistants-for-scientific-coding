...
[Positron](https://positron.posit.co/) is easier to setup for R users than VS Code. Most of what you can do in VS Code can also be done in Positron, Positron just being a clone of the VS Code source code. So try Positron first. If you can't use Positron for some reason, comprehensive instructions for VS Code and R are below in (@sec-vscodesetup) and. You may need IT help, especially if your computer is locked down for institutional security!
...
As a fall-back, you can follow this book via ChatGPT or Copilot, but it will lots of cutting and pasting. Not the integrated experience I want you to have.
...
- Less flexibility and customization than other agents
...
- Can customize how it works to optimize performance and cost
- BYO API key, can interact with any LLM
...
- BYO API key
- System messages customizable for advanced scientific applications of agents
- Large user base
...
For this workshop I **recommend you get an OpenRouter API key**. This will give you the most flexibility to try different models and to find models that have free options. Its a bit more expensive than buying tokens directly from the model's home provider, but gives you more flexibility. 
...
1. Open the Extensions view in Positron or VScode (Ctrl+Shift+X)
