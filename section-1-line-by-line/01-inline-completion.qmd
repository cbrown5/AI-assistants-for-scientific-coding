...
**Software requirements:** Positron or VS Code with R or Python and a GitHub Copilot license + extension (or RStudio with Copilot enabled — see [Setup](../02-setup.qmd)). Alternatively, a local LLM with the Continue extension or similar - see [local models](../section-8-local-models/index.qmd).
