...
Vibe coding isn't recommended for scientific projects — we'll come back to why in [Section 2](../section-2-agents/08-reviewing-agent-output.qmd) and [Section 6](../section-6-agentic-engineering/index.qmd).
...
- Get the assistant to write tests for your data pipeline — checking joins worked properly, and that you didn't duplicate or drop rows. We'll build this out properly in [Section 6](../section-6-agentic-engineering/index.qmd).
