...
Be careful with anything you didn't write yourself before attaching it to an agent session — check it doesn't contain hidden instructions. More on why in [Section 4](../section-4-security-privacy/01-security-risk-examples.qmd).
:::
