...
- Does the statistical approach match what you set out to do (the workflow in [Section 3](../section-3-workflows/01-select-statistical-approach.qmd)) — or did it quietly substitute something more familiar to it?
