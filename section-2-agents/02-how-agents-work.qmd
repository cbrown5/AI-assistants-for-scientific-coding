...
Open `system.md` in this repo — a real agent system prompt (Roo Code's, captured while that extension was still maintained; Cline's is similar). Find the section that lists its available tools. How many of them map onto the simple "read a file / write a file / run a command" set we'll build in Section 7?
:::
