...
Time to run an agent end-to-end. In VSCode, open the chat panel and switch the mode from "Ask" or "Edit" to "Agent" (in other tools, look for an equivalent mode or model switch — Cline and Claude Code default to agent-style behaviour).
