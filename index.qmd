...
Note the book is still under construction. Most sections are complete, but a few sections just have bullet points that I refer to when teaching the workshop. Its also a fast moving space, so the content needs constant updating. 
