...
- [Section 5: Agentic engineering for data analysis](section-5-agentic-engineering/index.qmd): Tests and verification, red-green TDD, and using simulated data as a verification step.
- [Section 6: LLM access via API](section-6-api-access/index.qmd): API keys, how ellmer talks to a provider, chat, a DIY chatbot, building your own minimal agent, and a literature review example.
