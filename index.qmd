...
**Citation: Brown, C.J. & Spillias, S. (2026). Prompting large language models for quality ecological statistics. *Methods in Ecology and Evolution*. [https://doi.org/10.1111/2041-210x.70267](https://doi.org/10.1111/2041-210x.70267)**

If you are using the material on agents and specification sheets, the companion study is:

**Citation: Brown, C.J., Aitken, J., Takyi, R. & Tisseaux-Navarro, A. (2026). Automating Ecological and Fisheries Modelling With Agentic AI. *Fish and Fisheries*. [https://doi.org/10.1111/faf.70079](https://doi.org/10.1111/faf.70079)**
...
You will need some time to set up the software. You may also need IT help if your computer is locked down. See [Setup](02-setup.qmd) for more detailed instructions.

## Book overview

The book is organised as short, self-paced modules — each about 10 minutes — grouped into bigger sections. 
...
- [Section 8: Local LLMs](section-8-local-models/index.qmd): API keys, how ellmer talks to a provider, chat, a DIY chatbot, building your own minimal agent, and a literature review example.
