...
We explore [data privacy risks in more detail in an upcoming study](section-4-security-privacy/04-keeping-data-secure.qmd). My collaborator, James Smith, has even developed an R package [confideR](https://github.com/smithja16/confideR), which you can run to audit potential data privacy risks in your current R session. 
...
Some agents can be told to ignore specific folders — for example, a repository-level custom instruction to [GitHub Copilot](https://docs.github.com/en/copilot/customizing-copilot/adding-repository-custom-instructions-for-github-copilot), or Cline's `.clineignore` file.
