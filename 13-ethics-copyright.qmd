...
Does AI make our brains lazy? [One study found](https://www.nature.com/articles/d41586-025-02005-y) less engagement and deep thinking for students who had access to chatGPT for writing an essay compared to students who just had web searches or had no internet connectivity. 
...
Asking a finished LLM questions uses much less energy, but cumulatively across the globe it adds up. Here are a few informative statistics I found online:
...
Here's an [alterantive analysis](https://andymasley.substack.com/p/the-ai-water-issue-is-fake) of water use based on prompting chatGPT. That analysis finds LLM water use is minimal, especially when put in context of water use on Golf Courses! Note though that using LLMs for coding is a much heavier use that occaisonal questions to chatGPT. 

Of course, the carbon cost is global, whereas the water cost is localised (Probably to US data centres). 
...
#### Option 4: Service with no data retention policy 
