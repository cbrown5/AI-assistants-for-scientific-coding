# Writing documents with Quarto and AI assistants

Below is my suggested workflow for using quarto to write scientific papers with the help of AI assistants. I'm currently switching to doing as many projects as possible with quarto rather than word for a few reasons:
...
Download and install VScode as per @sec-vscodesetup.
...
Get an API key with an LLM provider see @sec-apikeys.

Get an AI assistant extension for your IDE. Here I'll assume you are using the Roo Code extension for VSCode @sec-otheroptions.
