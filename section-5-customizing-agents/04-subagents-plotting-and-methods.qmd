...
::: {.callout-note title="Prompt (plotting sub-agent)" appearance="simple"}
...
::: {.callout-note title="Prompt (methods sub-agent)" appearance="simple"}
...
This is the same context-poisoning concern from [Section 2](../section-2-agents/09-when-agents-get-stuck.qmd), applied deliberately — a fresh, narrowly-scoped sub-agent can't inherit a mistake from an earlier stage of the pipeline it never saw.
:::
